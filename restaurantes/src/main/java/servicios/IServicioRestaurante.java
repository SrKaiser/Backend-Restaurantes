...
public interface IServicioRestaurante {
	...
	public List<SitioTuristico> obtenerSitiosTuristicosProximos(String idRestaurante, int radius, int maxRows) throws RepositorioException, EntidadNoEncontrada;
